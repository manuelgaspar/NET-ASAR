#!/bin/bash
#Reads the regions contained in the HS*.oxch.seg files (created with CHESTER, available at https://github.com/pratas/chester under GPLv3) and outputs a file for each chromosome
